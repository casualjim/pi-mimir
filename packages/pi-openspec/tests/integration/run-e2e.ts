...
assertIncludes(list, "@casualjim/pi-openspec", "install/list");
...
assertIncludes(guidance, "pi-review", "workflow guidance");
...
assertNotIncludes(readdirSync(projectSkillsDir).join(","), "review-implementation", "skill sync");
