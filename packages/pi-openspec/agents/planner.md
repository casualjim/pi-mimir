...
Use codebase-memory for codebase context before direct reads or discovery subagents:
...
If codebase-memory is unavailable or stale, explicitly report degraded discovery, fall back to exact file reads or shell inspection, and do not claim architecture-aware discovery was completed.
