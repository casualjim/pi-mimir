...
import { syncBundledAgents, BUNDLED_AGENTS_DIR, PACKAGE_ROOT } from "../extensions/openspec-core/agents.js";
...
describe("agents", () => {
	...
	describe("PACKAGE_ROOT resolution", () => {
		it("resolves to packages/core/", () => {
			// PACKAGE_ROOT should end with packages/core
			expect(PACKAGE_ROOT).toContain("packages/core");
			expect(PACKAGE_ROOT).not.toContain("openspec-core");
		});
