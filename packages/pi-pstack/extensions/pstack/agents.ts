 ...
 * package resource manifests. Keep pi-pstack's bundled agents there as managed
 * copies so pi-subagents can run them with `agent: "poteto-agent"` etc.
 *
...
export const PSTACK_MANAGED_MANIFEST = 'pstack-managed.json';
...
function manifestPath(): string {
  return join(getAgentRoot(), PSTACK_MANAGED_MANIFEST);
}
...
export function syncBundledPstackAgents(): SyncResult {
