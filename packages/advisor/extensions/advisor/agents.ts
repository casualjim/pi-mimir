...
import { ADVISOR_MANAGED_MANIFEST, readAdvisorManagedManifest } from "./managed-manifest.js";
...
export interface SyncError {
	file?: string;
	op: "read-dest" | "remove" | "manifest-read";
	message: string;
}
...
function removeManifest(cwd: string): void {
	rmSync(join(cwd, ADVISOR_MANAGED_MANIFEST), { force: true });
}
