...
- **Files added**: 5 new files (4 SKILL.md + 1 agent .md) under `packages/core/`
- **Package manifest**: `packages/core/package.json` may need `pi.skills` and `pi.agents` field adjustments to register the new directories
