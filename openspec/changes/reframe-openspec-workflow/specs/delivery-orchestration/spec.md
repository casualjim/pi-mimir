...
The worker SHALL run claim, architecture, tests, performance, and security review skills after verification passes via subagents whose prompts start with `/skill:<openspec-skill-name> <change-name>`.
