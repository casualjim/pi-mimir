...
- **WHEN** `packages/pi-mimir/openspec/schemas/review-gated/schema.yaml` is inspected
...
- **WHEN** a template under `packages/pi-mimir/openspec/schemas/review-gated/templates/` is inspected
