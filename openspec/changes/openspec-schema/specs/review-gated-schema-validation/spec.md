...
- **THEN** it touches `packages/pi-mimir/openspec/schemas/review-gated/schema.yaml` and any necessary files under `packages/pi-mimir/openspec/schemas/review-gated/templates/`
